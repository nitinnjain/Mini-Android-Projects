...
public class EditorActivity extends AppCompatActivity {
    ...
    private void insertPet() {
        ...
        int weightOfPet = Integer.parseInt(weight);

        ContentValues value = new ContentValues();
        value.put(PetEntry.COLUMN_PET_NAME, nameOfPet);
        value.put(PetEntry.COLUMN_PET_BREED, breedOfPet);
        value.put(PetEntry.COLUMN_PET_GENDER, mGender);
        value.put(PetEntry.COLUMN_PET_WEIGHT, weightOfPet);
